...
namespace Carbon\Plaintext\Service;
...
class Html2TextService
{
    ...
    #[Flow\Inject('Carbon.Plaintext:PlaintextLogger', false)]
    ...
    protected $searchList = [
        ...
        '/<mj-style\b[^>]*>.*?<\/mj-style>/i',                                   // <mj-style>s -- which strip_tags supposedly has problems with
        '/<mj-head\b[^>]*>.*?<\/mj-head>/i',                                          // <mj-head> -- which strip_tags supposedly has problems with
        ...
        '/<plaintext-spacer\b[^>]*>/i',                                          // <plaintext-spacer>
        ...
        '/(<mj-text\b[^>]*>|<\/mj-text>)/i',                                     // <mj-text> and </mj-text>
        '/<(mj-carousel-image)\b[^>]*alt=\"([^>"]+)\"[^>]*>/i',                  // <mj-carousel-image>
        '/<(mj-image)\b[^>]*alt=\"([^>"]+)\"[^>]*>/i',                           // <mj-image>
    ];
    ...
    protected function replaceList(): array
    {
        ...
        return [
            ...
            "",                                        // <mj-style>s -- which strip_tags supposedly has problems with
            "",                                        // <mj-head> -- which strip_tags supposedly has problems with
            ...
            "\n",                                      // <mj-hero> and </mj-hero>
            "\n",                                      // <mj-text> and </mj-text>
            $imageReplace,                             // <mj-carousel-image> with alt tag
            $imageReplace,                             // <mj-image> with alt tag
        ];
    }
